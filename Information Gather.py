...
def writeTXT(area_list, aspect_ratio_list, perimeter_list,match_score_list):
    f = open("Right_Correct+Defects_Training_Data","a")
    i=0
    for area in area_list:
...
def DataGather(isStraight, isLeft, isRight):
    ...
    for i in range (5):
        ...
        area_list, aspect_ratio_list, perimeter_list, match_score_list = FeatureExtraction(img_rgb,contour_filter,straightContour)
