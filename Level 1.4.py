...
def plcOutput(Pass,batch):
    ...
    my_results_plc=ResultsSave('group5_vision_result_dummy.csv','group5_plc_result_lvl1'+str(batch)+'.csv')
...
def cropStraightImage(img):
    ...
    #Save results        
    my_results_vision=ResultsSave('group5_vision_result_lvl1'+str(tray_counter)+'.csv','group5_plc_result_dummy.csv')
...
def captureImage(img_count):
    ...
    while True: 
        ...
        if k%256 == 27:
            ...
            # ESC not pressed
            img_name = "./group5_demo_images/lvl1_tray_{}".format(img_counter)
